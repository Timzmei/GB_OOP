...
public abstract class Shooter extends Unit {
    ...
    public Shooter(String name, String faction, int cost, int level, int defense, int damage, int maxHp, int hp, int movement, int speed, int initiative, int distance, int maxCountBullet, float accuracy, Banda banda, int x, int y) {
        super(name, faction, cost, level, defense, damage, maxHp, hp, movement, speed, initiative, banda, x, y);
